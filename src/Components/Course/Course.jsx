...
<dialog id="my_modal_1" className="">
  <div className="bg-slate-600 p-3 rounded-xl h-80 text-center pt-28">
    <h3 className="font-bold text-xl text-center">Already added!</h3>
    <p className="py-4">You cannot add same course more than one time</p>
    <div className="">
      <form method="dialog">
      ...
      {/* <Modal
        ...
        contentLabel="Already Added Modal"
      >
        <h2>Already Added</h2>
